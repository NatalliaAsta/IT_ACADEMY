...
public class ConeContainer extends ContainerBase implements ContainerShaped {
    public ConeContainer(ContainerSize size, Density density) {
        super(Shape.CONE, size, density);
    }
